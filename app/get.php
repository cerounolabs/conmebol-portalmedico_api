            ...
            try {
                ...
                while ($rowMSSQL = $stmtMSSQL->fetch()) {
                    $detalle    = array(
                        ...
                        'examen_fecha_1'                                => date_format(date_create($rowMSSQL['examen_fecha_1']), 'd/m/Y'),
                        'examen_fecha_2'                                => date_format(date_create($rowMSSQL['examen_fecha_2']), 'd/m/Y'),
                        'examen_fecha_3'                                => date_format(date_create($rowMSSQL['examen_fecha_3']), 'd/m/Y'),
                        ...
                        'examen_laboratorio_fecha_envio'                => date_format(date_create($rowMSSQL['examen_laboratorio_fecha_envio']), 'd/m/Y'),
                        'examen_laboratorio_fecha_recepcion'            => date_format(date_create($rowMSSQL['examen_laboratorio_fecha_recepcion']), 'd/m/Y'),
                        ...
                        'examen_anterior_fecha_1'                       => date_format(date_create($rowMSSQL['examen_anterior_fecha_1']), 'd/m/Y'),
                        'examen_anterior_fecha_2'                       => date_format(date_create($rowMSSQL['examen_anterior_fecha_2']), 'd/m/Y'),
                        'examen_anterior_fecha_3'                       => date_format(date_create($rowMSSQL['examen_anterior_fecha_3']), 'd/m/Y'),
                        ...
                        'examen_anterior_laboratorio_fecha_envio'       => date_format(date_create($rowMSSQL['examen_anterior_laboratorio_fecha_envio']), 'd/m/Y'),
                        'examen_anterior_laboratorio_fecha_recepcion'   => date_format(date_create($rowMSSQL['examen_anterior_laboratorio_fecha_recepcion']), 'd/m/Y'),
