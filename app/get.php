            ...
            try {
                ...
                while ($rowMSSQL = $stmtMSSQL->fetch()) {
                    $detalle    = array(
                        ...
                        'examen_laboratorio_fecha_envio'                => date_format(date_create($rowMSSQL['examen_laboratorio_fecha_envio'])),
                        'examen_laboratorio_fecha_recepcion'            => date_format(date_create($rowMSSQL['examen_laboratorio_fecha_recepcion'])),
                        ...
                        'examen_anterior_laboratorio_fecha_envio'       => date_format(date_create($rowMSSQL['examen_anterior_laboratorio_fecha_envio'])),
                        'examen_anterior_laboratorio_fecha_recepcion'   => date_format(date_create($rowMSSQL['examen_anterior_laboratorio_fecha_recepcion'])),
