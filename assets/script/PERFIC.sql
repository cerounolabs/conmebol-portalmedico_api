...
CREATE TRIGGER [adm].[PERFIC_INSERT] 
	...
	BEGIN
		SET NOCOUNT ON;
		INSERT INTO [adm].[PERFICA] (PERFICAMET, PERFICAUSU, PERFICAFEC, PERFICADIP, PERFICACOD, PERFICAEST, PERFICATIP, PERFICAROL, PERFICAEQU, PERFICANOM, PERFICAUSE, PERFICACON, PERFICAPAT, PERFICAMAI, PERFICATEF, PERFICAOBS)
		SELECT 'INSERT AFTER', i.PERFICAUS, GETDATE(), i.PERFICAIP, i.PERFICCOD, i.PERFICEST, i.PERFICTIP, i.PERFICROL, i.PERFICEQU, i.PERFICNOM, i.PERFICUSE, i.PERFICCON, i.PERFICPAT, i.PERFICMAI, i.PERFICTEF, i.PERFICOBS FROM INSERTED i;
	END
GO
...
CREATE TRIGGER [adm].[PERFIC_UPDATE] 
	...
	BEGIN
		SET NOCOUNT ON;
		INSERT INTO [adm].[PERFICA] (PERFICAMET, PERFICAUSU, PERFICAFEC, PERFICADIP, PERFICACOD, PERFICAEST, PERFICATIP, PERFICAROL, PERFICAEQU, PERFICANOM, PERFICAUSE, PERFICACON, PERFICAPAT, PERFICAMAI, PERFICATEF, PERFICAOBS)
        SELECT 'UPDATE BEFORE', d.PERFICAUS, GETDATE(), d.PERFICAIP, d.PERFICCOD, d.PERFICEST, d.PERFICTIP, d.PERFICROL, d.PERFICEQU, d.PERFICNOM, d.PERFICUSE, d.PERFICCON, d.PERFICPAT, d.PERFICMAI, d.PERFICTEF, d.PERFICOBS FROM DELETED d;

		INSERT INTO [adm].[PERFICA] (PERFICAMET, PERFICAUSU, PERFICAFEC, PERFICADIP, PERFICACOD, PERFICAEST, PERFICATIP, PERFICAROL, PERFICAEQU, PERFICANOM, PERFICAUSE, PERFICACON, PERFICAPAT, PERFICAMAI, PERFICATEF, PERFICAOBS)
        SELECT 'UPDATE AFTER', i.PERFICAUS, GETDATE(), i.PERFICAIP, i.PERFICCOD, i.PERFICEST, i.PERFICTIP, i.PERFICROL, i.PERFICEQU, i.PERFICNOM, i.PERFICUSE, i.PERFICCON, i.PERFICPAT, i.PERFICMAI, i.PERFICTEF, i.PERFICOBS FROM INSERTED i;
	END
GO
...
CREATE TRIGGER [adm].[PERFIC_DELETE] 
	...
	BEGIN
		SET NOCOUNT ON;
		INSERT INTO [adm].[PERFICA] (PERFICAMET, PERFICAUSU, PERFICAFEC, PERFICADIP, PERFICACOD, PERFICAEST, PERFICATIP, PERFICAROL, PERFICAEQU, PERFICANOM, PERFICAUSE, PERFICACON, PERFICAPAT, PERFICAMAI, PERFICATEF, PERFICAOBS)
        SELECT 'DELETE BEFORE', d.PERFICAUS, GETDATE(), d.PERFICAIP, d.PERFICCOD, d.PERFICEST, d.PERFICTIP, d.PERFICROL, d.PERFICEQU, d.PERFICNOM, d.PERFICUSE, d.PERFICCON, d.PERFICPAT, d.PERFICMAI, d.PERFICTEF, d.PERFICOBS FROM DELETED d;
	END
GO