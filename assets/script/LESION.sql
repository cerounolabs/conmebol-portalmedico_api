...
CREATE TABLE [lesion].[LESFIC](
    ...
    [LESFICFER] [date] NULL, --FECHA RETORNO
    ...
    [LESFICRET] [int] NULL, --LESION RETIRO (NO - SI - SIN INFORMACION)
    [LESFICCIR] [int] NULL, --LESION CIRUGIA (SI - NO)
    [LESFICEX1] [int] NULL, --LESION EXAMEN RX
    [LESFICEX2] [int] NULL, --LESION EXAMEN US
    [LESFICEX3] [int] NULL, --LESION EXAMEN TC
    [LESFICEX4] [int] NULL, --LESION EXAMEN RM
    [LESFICEX5] [int] NULL, --LESION EXAMEN OTR
    ...
    [LESFICDIR] [int] NULL, --DIAGNOSTICO TIPO RETORNO
    [LESFICREC] [int] NULL, --DIAGNOSTICO RECUPERACION
    [LESFICTIE] [int] NULL, --DIAGNOSTICO TIEMPO (DIAS - SEMANAS - MESES)
    [LESFICOBD] [varchar](5120) NULL, --DIAGNOSTICO OBSERVACION
    [LESFICOBR] [varchar](5120) NULL, --DIAGNOSTICO OBSERVACION RETORNO
    [LESFICTRR] [varchar](5120) NULL, --DIAGNOSTICO TRATAMIENTO RETORNO
    [LESFICOBS] [varchar](5120) NULL, --OBSERVACION
