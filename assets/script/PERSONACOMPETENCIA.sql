...
CREATE TABLE [aud].[PERCOM](
	...
	[PERCOMTMC] [int] NOT NULL,
	[PERCOMOBS] [varchar](5120) NULL,
 CONSTRAINT [PK_PERCOMIDD] PRIMARY KEY CLUSTERED ([PERCOMIDD] ASC) WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]) ON [PRIMARY]
GO
...
CREATE TRIGGER [adm].[PERCOM_INSERT] 
	...
	BEGIN
		SET NOCOUNT ON;
		INSERT INTO [aud].[PERCOM] (PERCOMAME, PERCOMAUS, PERCOMAFH, PERCOMAIP, PERCOMCOC, PERCOMPEC, PERCOMTMC, PERCOMOBS)
