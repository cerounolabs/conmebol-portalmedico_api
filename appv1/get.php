<?php
    ...
    /*APARTIR DE AQUI*/
    $app->get('/v1/100/equipo/codigo/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
...
//                    'tipo_documento_nombre_portugues'       => strtoupper(strtolower(trim($rowMSSQL['tipo_documento_nombre_portugues']))),
    ...
    $app->get('/v1/200/competicion/equipo/alta/{equipo}/{competicion}/{tipo}/{encuentro}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/200/competicion/examen/{competicion}/{encuentro}/{tipo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/400/medico/competicion', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/801/examen/prueba/{equipo}/{encuentro}', function($request) {
        require __DIR__.'/../src/connect.php';
...
/*MODULO NOTIFICACIONES*/
    ...
    $app->get('/v1/802/notificacionequipo/listado', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/802/notificacionequipo/codigo/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/802/notificacionequipo/notificacion/{notificacion}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/802/notificacionmensaje/listado', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/802/notificacionmensaje/medico/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    /*MODULO ACREDITACION*/
    $app->get('/v1/400/acreditacion/competicion/listado', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/400/acreditacion/competicion/codigo/{competicion}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/400/acreditacion/competicion/{competicion}/encuentro', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v1/400/acreditacion/competicion/{competicion}/equipo/{equipo}', function($request) {
        require __DIR__.'/../src/connect.php';
