<?php
        ...
        try {
            ...
            while ($rowMSSQL = $stmtMSSQL->fetch()) {
                ...
                $detalle    = array(
                    ...
                    'tipo_parametro'                    => $rowMSSQL['tipo_parametro'],
    ...
    $app->get('/v2/401/competicion/{equipo}/{persona}', function($request) {//20201123
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/persona/test/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
            ...
            try {
                ...
                while ($rowMSSQL = $stmtMSSQL00->fetch()) {
                    ...
                    $detalle    = array(
                        ...
                        'tipo_estado_codigo'                            => $rowMSSQL['tipo_estado_codigo'],
                        'tipo_estado_orden'                             => $rowMSSQL['tipo_estado_orden'],
                        'tipo_estado_nombre_ingles'                     => strtoupper(strtolower(trim($rowMSSQL['tipo_estado_nombre_ingles']))),
                        'tipo_estado_nombre_castellano'                 => strtoupper(strtolower(trim($rowMSSQL['tipo_estado_nombre_castellano']))),
                        'tipo_estado_nombre_portugues'                  => strtoupper(strtolower(trim($rowMSSQL['tipo_estado_nombre_portugues']))),
                        'tipo_estado_path'                              => strtolower(trim($rowMSSQL['tipo_estado_path'])),
                        'tipo_estado_dominio'                           => strtoupper(strtolower(trim($rowMSSQL['tipo_estado_dominio']))),
                        'tipo_estado_parametro'                         => $rowMSSQL['tipo_estado_parametro'],
                        'tipo_estado_observacion'                       => strtoupper(strtolower(trim($rowMSSQL['tipo_estado_observacion']))),

                        'tipo_examen_codigo'                            => $rowMSSQL['tipo_examen_codigo'],
                        'tipo_examen_orden'                             => $rowMSSQL['tipo_examen_orden'],
                        'tipo_examen_nombre_ingles'                     => strtoupper(strtolower(trim($rowMSSQL['tipo_examen_nombre_ingles']))),
                        'tipo_examen_nombre_castellano'                 => strtoupper(strtolower(trim($rowMSSQL['tipo_examen_nombre_castellano']))),
                        'tipo_examen_nombre_portugues'                  => strtoupper(strtolower(trim($rowMSSQL['tipo_examen_nombre_portugues']))),
                        'tipo_examen_path'                              => strtolower(trim($rowMSSQL['tipo_examen_path'])),
                        'tipo_examen_dominio'                           => strtoupper(strtolower(trim($rowMSSQL['tipo_examen_dominio']))),
    ...
    $app->get('/v2/200/persona/testcantidad/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/persona/competicion/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/competicion/listado/padre/{competicion}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/competicion/{competicion}/encuentro', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/competicion/{competicion}/encuentro/{encuentro}/equipo', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/200/competicion/{competicion}/encuentro/{encuentro}/equipo/{equipo}/tipo/{tipo}/examen', function($request) {
        require __DIR__.'/../src/connect.php';
            ...
            if ($val01 == 39393) {
                if ($val04 == 0) {
                    $sql00  = "SELECT
                        ...
                        WHERE a.superiorCompetitionFifaId = ? AND d.personFifaId IS NOT NULL AND NOT EXISTS (SELECT * FROM exa.EXAFIC a1 WHERE a1.EXAFICPEC = c.personFifaId AND a1.EXAFICTEC = ? AND a1.EXAFICENC = ? AND a1.EXAFICEST <> (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'EXAMENMEDICOCOVID19ESTADO' AND DOMFICPAR = 3) AND a1.EXAFICEST <> (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'EXAMENMEDICOCOVID19ESTADO' AND DOMFICPAR = 5) AND c.EXAFICEST <> (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'EXAMENMEDICOCOVID19ESTADO' AND DOMFICPAR = 6))
    ...
    $app->get('/v2/200/competicion/home/ultimoencuentro/{equipo}/{usuario}/{examen}', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        if (isset($val01) && isset($val02) && isset($val03)) {
                $sql00  = "SELECT TOP 4
                    ...
                    WHERE (a.EQUIPO_LOCAL_CODIGO = ? OR a.EQUIPO_VISITANTE_CODIGO = ?) AND a.JUEGO_NOMBRE IS NOT NULL AND a.JUEGO_HORARIO IS NOT NULL AND EXISTS(SELECT * FROM adm.PERCOM WHERE (PERCOMCOC = a.COMPETICION_ID OR PERCOMCOC = a.COMPETICION_PADRE_ID) AND PERCOMPEC = ? AND PERCOMTMC = (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'USUARIOMODULO' AND DOMFICPAR = ?))
    ...
    $app->get('/v2/200/competicion/examen/{competicion}/{encuentro}/{tipo}', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        if (isset($val01) && isset($val02) && isset($val03)) {
            $sql00  = "SELECT
                ...
                WHERE (c.COMPETICION_ID = ? OR c.COMPETICION_PADRE_ID = ?) AND a.EXAFICENC = ? AND a.EXAFICTEC = (SELECT DOMFICCOD FROM adm.DOMFIC WHERE DOMFICVAL = 'EXAMENMEDICOTIPO' AND DOMFICPAR = ?)
...
/*MODULO NOTIFICACIONES*/
    ...
    $app->get('/v2/802/notificacionequipo/notificacion/{notificacion}', function($request) {
        require __DIR__.'/../src/connect.php';
        
        $val01      = $request->getAttribute('notificacion');
    ...
    $app->get('/v2/802/notificacionmensaje/listado', function($request) {
        require __DIR__.'/../src/connect.php';
        ...
        try {
                ...
                while ($rowMSSQL = $stmtMSSQL->fetch()) {
                    ...
                    if ($rowMSSQL['notificacion_mensaje_fecha_proceso'] == '1900-01-01' || $rowMSSQL['notificacion_mensaje_fecha_proceso'] == null){
                        $notificacion_mensaje_fecha_proceso_1 = '';
                        $notificacion_mensaje_fecha_proceso_2 = '';
                    } else {
                        $notificacion_mensaje_fecha_proceso_1 = $rowMSSQL['notificacion_mensaje_fecha_proceso'];
                        $notificacion_mensaje_fecha_proceso_2 = date('d/m/Y', strtotime($rowMSSQL['notificacion_mensaje_fecha_proceso']));
                    }
                    ...
                    $detalle    = array(
                        ...
                        'notificacion_mensaje_codigo'               =>  $rowMSSQL['notificacion_mensaje_codigo'],
                        'notificacion_mensaje_orden'                =>  $rowMSSQL['notificacion_mensaje_orden'],
                        'notificacion_mensaje_fecha_proceso_1'      =>  $notificacion_mensaje_fecha_proceso_1,
                        'notificacion_mensaje_fecha_proceso_2'      =>  $notificacion_mensaje_fecha_proceso_2,
                        'notificacion_mensaje_encuentro'            =>  $rowMSSQL['notificacion_mensaje_encuentro'],
                        'notificacion_mensaje_descripcion'          =>  trim($rowMSSQL['notificacion_mensaje_descripcion']),
                        'notificacion_mensaje_observacion'          =>  trim($rowMSSQL['notificacion_mensaje_observacion']),
                ...
                if (isset($result)){
                    ...
                    $detalle = array(
                        'notificacion_mensaje_codigo'               =>  '',
                        'notificacion_mensaje_orden'                =>  '',
                        'notificacion_mensaje_fecha_proceso_1'      =>  '',
                        'notificacion_mensaje_fecha_proceso_2'      =>  '',
                        'notificacion_mensaje_encuentro'            =>  '',
                        'notificacion_mensaje_descripcion'          =>  '',
                        'notificacion_mensaje_observacion'          =>  '',
    ...
    $app->get('/v2/802/notificacionmensaje/medico/{codigo}', function($request) {
        require __DIR__.'/../src/connect.php';
...
/*MODULO ACREDITACION*/
    ...
    $app->get('/v2/400/acreditacion/competicion/codigo/{competicion}', function($request) {
        require __DIR__.'/../src/connect.php';
                ...
                while ($rowMSSQL = $stmtMSSQL->fetch()) {
                    ...
                    while ($rowMSSQL01 = $stmtMSSQL01->fetch()) {
                        ...
                        $detalle   = array(
                            ...
                            'equipo_nombre_corto'                   => trim($rowMSSQL01['equipo_nombre_corto']),
                            'equipo_naturaleza'                     => trim($rowMSSQL01['equipo_naturaleza']),
                            'equipo_pais'                           => trim($rowMSSQL01['equipo_pais']),
    ...
    $app->get('/v2/400/acreditacion/competicion/{competicion}/encuentro', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/400/acreditacion/competicion/{competicion}/equipo/{equipo}', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/400/acreditacion/persona/zona', function($request) {
        require __DIR__.'/../src/connect.php';
    ...
    $app->get('/v2/400/acreditacion/persona/oficial', function($request) {
        require __DIR__.'/../src/connect.php';
