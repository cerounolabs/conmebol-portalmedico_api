    ...
    $app->delete('/v2/200/competicion/medico/{competicion}/{persona}', function($request) {
        ...
        if (isset($val01) && isset($val02)) {
            ...
            try {
                ...
                header("Content-Type: application/json; charset=utf-8");
                $json       = json_encode(array('code' => 200, 'status' => 'ok', 'message' => 'Success DELETE', 'codigo' => $val01.', '.$val01), JSON_UNESCAPED_UNICODE | JSON_NUMERIC_CHECK | JSON_PRESERVE_ZERO_FRACTION);
